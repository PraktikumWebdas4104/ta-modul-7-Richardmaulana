	...
	if (isset($_POST['cari'])) {
		...
		if ($search==$row['nim']) {
			...
			foreach ($qry as $row) {
				...
				echo "Tampilkan semua <a href='lihatdata.php'>Data</a><br><br>";
			}
		}
		else{
			echo "<h3 style='color:red'>Data yang dicari tidak ditemukan<br>";
			echo "Tampilkan semua <a href='lihatdata.php'>Data</a></h3>";
		}
	}
	else{
		...
		echo "</table>";
		echo "<br>Klik <a href='inputdata.php'> disini </a> untuk tambah data.";
?>
